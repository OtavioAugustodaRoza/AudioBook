...
function App() {
  ...
  return (
    <section className="flex flex-col gap-6 justify-center items-center min-h-screen bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] text-white">
      <img
        src={atual.img}
        alt={atual.name}
